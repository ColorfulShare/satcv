        ...
        <table class="" style="width: 100%;">
          <tbody>
            ...
            <tr>
              ...
              <td style="width: 50%;"><p class="text-center"><u>{{$contract->user()->fullname()}}<u></p></td>
            </tr>
            <tr>
              <td style="width: 50%;"><p class="text-center"><u>105007768-2</u></p></td>
              <td style="width: 50%;">{{$contract->user()->dni}}</td>
            </tr>
            <tr>
