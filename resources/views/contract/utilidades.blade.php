    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body card-dashboard">
                <button class="btn btn-danger float-right" data-toggle="modal" data-target="#ModalUtilidad">Pagar utilidar</button>
                    ...
                    <table class="table w-100 nowrap scroll-horizontal-vertical myTable table-striped w-100">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>{{strftime("%B", \Carbon\Carbon::createFromFormat('!m',$utility->month)->getTimestamp())}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="porcentaje" aria-describedby="porcentaje" name="porcentaje">
            <div class="mb-3">
