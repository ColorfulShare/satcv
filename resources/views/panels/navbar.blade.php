...
<nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center {{ $configData['navbarColor'] }}"
    ...
    <nav
        ...
        <div class="navbar-container d-flex content">
            ...
            data-toggle="tooltip" data-placement="top" title="Email"><i class="ficon" data-feather="mail"></i></a></li>
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            ...
            <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                <div class="media-heading">
                    <h6 class="cart-item-title"><a class="text-body" href="{{url('app/ecommerce/details')}}"> Apple
            ...
            <div class="media align-items-center"><img class="d-block rounded mr-1"
                ...
                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                    <div class="media-heading">
                        <h6 class="cart-item-title"><a class="text-body" href="{{url('app/ecommerce/details')}}"> Google
            ...
            <div class="media align-items-center"><img class="d-block rounded mr-1"
                ...
                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                    <div class="media-heading">
                        <h6 class="cart-item-title"><a class="text-body" href="{{url('app/ecommerce/details')}}"> iPhone
                                11 Pro</a></h6><small class="cart-item-by">By Apple</small>
                    </div>
                    <div class="cart-item-qty">
                        <div class="input-group">
            ...
            <div class="media align-items-center"><img class="d-block rounded mr-1"
                ...
                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                    <div class="media-heading">
                        <h6 class="cart-item-title"><a class="text-body" href="{{url('app/ecommerce/details')}}"> iMac
        ...
        <div class="media-body">
            ...
            <div class="media d-flex align-items-start">
                <div class="media-left">
                    <div class="avatar"><img src="{{asset('images/portrait/small/avatar-s-3.jpg')}}" alt="avatar"
                            width="32" height="32"></div>
                </div>
                <div class="media-body">
        ...
        <li class="nav-item dropdown dropdown-user">
            <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
                ...
                <div class="user-nav d-sm-flex d-none">
                    ...
                    <span class="user-status text-primary"><b>Admin</b></span>
                    @endif
                </div>
                ...
                @else
                <span class="avatar">
                    <img class="round" src="https://ui-avatars.com/api/?background=random&name={{ Auth::user()->name }}"
                        alt="{{ Auth::user()->name }}" height="40px" width="40px">
                    @if (Auth::user()->status == 0)
                    <span class="avatar-status-busy"></span>
                    @else
                    <span class="avatar-status-online"></span>
