 ...
 <x-jet-validation-errors class="mb-4"/>
        ...
        <!-- Login-->
             ...
             <div class="mb-1">
                    ...
                    <input class="form-control border border-dark " id="email" type="text" required name="email" aria-describedby="email" autofocus="" tabindex="1"/>
             </div>
             <div class="mt-3">
             ...
             <div class="input-group input-group-merge form-password-toggle">
                   <input class="form-control form-control-merge border-dark" required id="password" type="password"
                   name="password" aria-describedby="password"
                   tabindex="2" />
             </div>
             <div class="mb-1">
                 <div class="form-check">
                     <input class="form-check-input border-dark" id="remember-me" type="checkbox" tabindex="3" />
                ...
                <p class="text-center mt-2"><span>¿Aun no Tienes Cuenta?</span><a
                  href="{{ route('register') }}"><span>&nbsp;<b>Registrate</b></span></a>
               </p>  
                </div>
            </div>
